...
const CartItem = () => {
    ...
    return (
        <div className="w-full">
            <ScrollArea className="flex-1 h-[23dvh] md:h-[30dvh] lg:h-[24dvh] 2xl:h-[32dvh] whitespace-nowrap overflow-y-auto">
                <ul>
                            ...
                            <div className="mb-8 flex border-b">
                                ...
                                <div className="relative flex flex-1 flex-col justify-between">
                                    <div className="flex justify-between items-center pl-4">
                                        ...
                                        <div className="flex items-start gap-x-3 md:w-[25%] 2xl:w-[40%]">
                                            <div
